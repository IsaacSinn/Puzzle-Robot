...
canvas = cv2.imread('./Puzzle Data/Phone Cam/solved_vertical.jpg')
# Import our piece (we are going to use a clump for now)
piece = cv2.imread('./Puzzle Data/Phone Cam/small.jpg')
...
cropped_piece = cv2.imread('./Puzzle Data/Phone Cam/small_cropped.jpg')
